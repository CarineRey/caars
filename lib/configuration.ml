...
let parse_line_fields_of_rna_conf_file = function
  | [ id ; species ; ref_species ; path_fastx_single ; path_fastx_left ; path_fastx_right ; orientation ; run_trinity ; path_assembly ; run_apytram] ->
     ...
     let sample_fastq = match (parse_fastq_path path_fastx_single,
                             parse_fastq_path path_fastx_left,
                             parse_fastq_path path_fastx_right,
                             parse_orientation id orientation,
                             run_apytram,
                             run_trinity) with
       | ( None    , Some  _, Some _, Some (Right o), _    , _    ) -> Fastq_Paired_end (path_fastx_left, path_fastx_right, o)
       | ( Some  _ , None   , None  , Some (Left o) , _    , _    ) -> Fastq_Single_end (path_fastx_single, o)
